/* =========================================================================
   AGENTS VERSE — Base data singleton (ES module port of data.js)
   Converted from window.AV IIFE to a typed named export.
   ========================================================================= */
import type { AVData, Room, Agent, Lead, Metrics, Escalation, ActivityItem, Stage, StatusMap, Fmt } from './types';
...
export type { Room, Agent, Lead, Metrics, Escalation, ActivityItem, Stage, StatusMap, StatusMapEntry, Fmt, AVData } from './types';

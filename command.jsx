...
function EscalationCard({ e, onAction, expanded, onToggle }) {
  ...
  const kindLabel = { human:'Human requested', deal:'Deal approval', cost:'Cost warning' }[e.kind] || 'Escalation';
  return (
...
function HealthRow({ label, ok=true, note }) {
  return (
...
function CommandCenter({ onAction }) {
...
Object.assign(window, { CommandCenter, RevenueCostChart, EscalationCard });

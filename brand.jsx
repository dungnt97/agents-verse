/* =========================================================================
   AGENTS VERSE — Brand & Icons
   Monogram: an "A" frame with a node at its apex, standing on a floor line —
   an agent (node) inside a workspace (floor). Geometric, scalable.
   ========================================================================= */

// ---- Monogram mark (bold rounded "A" in orange) ----
function Mark({ size = 24, tile = false, stroke }) {
  const gid = 'mk' + Math.random().toString(36).slice(2, 7);
...
function Icon({ name, size = 18, sw = 1.6, style, className }) {
  return (
...
Object.assign(window, { Mark, Logo, Icon, ICONS });

...
function Bar({ w, h = 6, c = 'var(--ink-3)', r = 3, o = 1, mb = 0 }) {
...
function NewSite({ hue = 210, accent = 'var(--primary)' }) {
  const card = (extra) => ({ background: 'var(--surface-elev)', borderRadius: 6, border: '1px solid var(--border-soft)', ...extra });
  return (
...
function SiteMock({ variant = 'new', hue = 210, chrome = true, label, ratio = '62%', style }) {
  return (
...
Object.assign(window, { SiteMock, OldSite, NewSite, Bar });

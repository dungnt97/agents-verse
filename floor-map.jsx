...
const ROOM_ICON = { ceo:'command', research:'search', audit:'audits', design:'layers', code:'bolt', sales:'send', support:'user', finance:'dollar' };
const WORKFLOW = ['research','audit','design','code','sales','support','finance'];
...
function FloorMap({ compact = false, selected, onRoom, onAgent, height }) {
...
function RoomNode({ room, compact, selected, onClick, onAgent }) {
...
Object.assign(window, { FloorMap, smoothPath, WORKFLOW, ROOM_ICON });

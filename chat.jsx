/* =========================================================================
   AGENTS VERSE — Assistant chat widget (bottom-right)
   ========================================================================= */
...
function ChatWidget() {
  ...
  const [msgs, setMsgs] = useState([{ role:'bot', text:"Hi — I’m your Verse assistant. Your agency is running smoothly. Want a quick summary, or shall I show you what needs your attention?" }]);
...
Object.assign(window, { ChatWidget, chatReply });
